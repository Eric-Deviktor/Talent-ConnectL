    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-12">
          ...
          <button className="hidden sm:block px-6 py-2 border-2 border-green-500 text-green-500 rounded-lg hover:bg-green-500 hover:text-white transition-all duration-200 font-medium">
            Voir tout
          </button>
        </div>
          ...
          {services.map((service) => (
            ...
            >
              <div className="relative">
                ...
                <button className="absolute top-3 right-3 p-2 bg-white/90 text-gray-700 rounded-full hover:bg-white hover:text-red-500 transition-all duration-200">
              ...
              <div className="p-6">
                ...
                <h3 className="font-semibold text-gray-900 mb-3 line-clamp-2 group-hover:text-green-500 transition-colors duration-200">
                  {service.title}
                </h3>
        ...
        <div className="text-center mt-12">
          <button className="sm:hidden px-8 py-3 border-2 border-green-500 text-green-500 rounded-lg hover:bg-green-500 hover:text-white transition-all duration-200 font-medium">
